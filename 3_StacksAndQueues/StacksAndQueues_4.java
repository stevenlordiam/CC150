 ...
 * Question 3-4
 * In the classic problem of the Towers of Hanoi, you have 3 towers and Ndisks of different sizes 
...
/*
  ...
  key: 
  * recursive approach. If we can do it in (n-1), we can do it in n
  * Three steps:
